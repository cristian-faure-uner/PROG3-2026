...
export default class EspecialidadesServicio {
    ...
    modificar = async (id_especialidad, especialidad) => {
        // lógica de negocio, verificar si existe la especialidad a modificar
        ...
        // lógica de negocio, devolver la especialidad modificada
    ...
    eliminar = async (id_especialidad) => {
        // lógica de negocio, verificar si existe la especialidad a eliminar
        const existe = await this.especialidades.buscarPorId(id_especialidad);
        if(existe.length === 0) {
            return null;
        }
